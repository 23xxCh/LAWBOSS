...
class TestCheckEndpoint:
    ...
    def test_check_compliant_text(self, client):
        resp = client.post("/api/v1/check", json={
    ...
    def test_check_invalid_market(self, client):
        resp = client.post("/api/v1/check", json={
            "description": "测试",
            "category": "化妆品",
            "market": "JP",
    ...
    def test_check_invalid_category(self, client):
        resp = client.post("/api/v1/check", json={
            "description": "测试",
            "category": "武器",
            "market": "EU",
    ...
    def test_check_us_market(self, client):
        resp = client.post("/api/v1/check", json={
    ...
    def test_check_no_false_positive(self, client):
